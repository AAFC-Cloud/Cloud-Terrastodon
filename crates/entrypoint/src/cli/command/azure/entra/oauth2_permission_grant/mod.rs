...
pub mod azure_entra_oauth2_permission_grant_claim;
pub mod azure_entra_oauth2_permission_grant_claim_list;
...
pub use azure_entra_oauth2_permission_grant_claim::AzureEntraOAuth2PermissionGrantClaimArgs;
pub use azure_entra_oauth2_permission_grant_claim_list::AzureEntraOAuth2PermissionGrantClaimListArgs;
