...
impl AzureContainerInstanceListArgs {
    pub async fn invoke(self, auth_context: &AuthContext) -> Result<()> {
        ...
        info!(tenant_id = %tenant_auth_context.tenant_id, "Fetching Azure container instances");
        let container_instances = fetch_all_container_instances(&tenant_auth_context).await?;
        info!(
