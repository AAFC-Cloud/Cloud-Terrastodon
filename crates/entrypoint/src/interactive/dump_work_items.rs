use cloud_terrastodon_azure_devops::AzureDevOpsWorkItemQuery;
...
pub async fn dump_work_items(auth_context: &AzureDevOpsAuthContext) -> eyre::Result<()> {
