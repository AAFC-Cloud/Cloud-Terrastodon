...
crate::impl_facet_string_proxy!(RoleEligibilityScheduleName, value => value.to_string());
...
mod tests {
    ...
    fn json_round_trips_through_facet() -> eyre::Result<()> {
        ...
        let name = facet_json::from_str::<RoleEligibilityScheduleName>(json)?;
        assert_eq!(name, RoleEligibilityScheduleName::new(Uuid::nil()));
