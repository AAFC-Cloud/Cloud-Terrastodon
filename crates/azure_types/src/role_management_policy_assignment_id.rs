...
use crate::ManagementGroupScopedRoleManagementPolicyAssignmentId;
use crate::ResourceGroupId;
use crate::ResourceGroupScopedRoleManagementPolicyAssignmentId;
use crate::ResourceId;
use crate::ResourceScopedRoleManagementPolicyAssignmentId;
use crate::RoleManagementPolicyAssignmentName;
use crate::SubscriptionId;
use crate::SubscriptionScoped;
use crate::SubscriptionScopedRoleManagementPolicyAssignmentId;
use crate::UnscopedRoleManagementPolicyAssignmentId;
...
impl FromStr for RoleManagementPolicyAssignmentId {
    type Err = eyre::Error;

    fn from_str(s: &str) -> Result<Self> {
        RoleManagementPolicyAssignmentId::try_from_expanded(s)
    }
}
