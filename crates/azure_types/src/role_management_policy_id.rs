...
use crate::ManagementGroupScopedRoleManagementPolicyId;
use crate::ResourceGroupId;
use crate::ResourceGroupScopedRoleManagementPolicyId;
use crate::ResourceId;
use crate::ResourceScopedRoleManagementPolicyId;
use crate::RoleManagementPolicyAssignmentName;
use crate::SubscriptionId;
use crate::SubscriptionScoped;
use crate::SubscriptionScopedRoleManagementPolicyId;
use crate::UnscopedRoleManagementPolicyId;
...
crate::impl_facet_string_proxy!(RoleManagementPolicyId, value => value.expanded_form());
...
impl FromStr for RoleManagementPolicyId {
    type Err = eyre::Error;

    fn from_str(s: &str) -> Result<Self> {
        RoleManagementPolicyId::try_from_expanded(s)
    }
}
...
mod tests {
    ...
    fn it_works() -> Result<()> {
        ...
        let id = RoleManagementPolicyId::try_from_expanded(&id)?;
        let json = facet_json::to_string(&id)?;
        assert_eq!(json, facet_json::to_string(&id.expanded_form())?);
        assert_eq!(facet_json::from_str::<RoleManagementPolicyId>(&json)?, id);
        Ok(())
    }
}
