...
use crate::ResourceGroupScopedPolicyDefinitionId;
use crate::ResourceId;
use crate::ResourceScopedPolicyDefinitionId;
use crate::SubscriptionId;
use crate::SubscriptionScoped;
use crate::SubscriptionScopedPolicyDefinitionId;
...
impl FromStr for PolicyDefinitionId {
    type Err = eyre::Error;

    fn from_str(s: &str) -> Result<Self> {
        try_from_expanded_hierarchy_scoped(s)
    }
}
...
cloud_terrastodon_registry::register_arbitrary!(PolicyDefinitionId);
