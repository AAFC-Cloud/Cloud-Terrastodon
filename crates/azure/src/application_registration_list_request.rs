...
cloud_terrastodon_registry::register_thing!(ApplicationRegistrationListRequest);
cloud_terrastodon_registry::register_arbitrary!(ApplicationRegistrationListRequest);
cloud_terrastodon_registry::register_into_future!(ApplicationRegistrationListRequest => Vec<EntraApplicationRegistration>);
