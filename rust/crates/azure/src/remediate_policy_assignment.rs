...
use cloud_terrasotodon_core_azure_types::prelude::PolicyDefinitionId;
use cloud_terrasotodon_core_azure_types::prelude::PolicySetDefinitionId;
use cloud_terrasotodon_core_azure_types::prelude::ResourceGroupId;
