...
use cloud_terrasotodon_core_azure::prelude::RoleDefinition;
use cloud_terrasotodon_core_azure::prelude::RoleDefinitionId;
use cloud_terrasotodon_core_azure::prelude::ThinRoleAssignment;
use cloud_terrasotodon_core_azure::prelude::User;
